...
export default function AboutLedgerModal({ isOpen, onClose}) {
  ...
  return (
    <div className="fixed inset-0 z-100 flex items-center justify-center bg-black px-4">
      <div className="bg-white rounded-lg max-w-xl w-full p-6 relative shadow-xl text-left">
        <h2 className="text-lg md:text-xl font-bold mb-3">About the Christed Vault Ledger</h2>
