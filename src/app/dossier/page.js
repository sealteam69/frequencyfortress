    ...
    >
      ...
      <div className="flex justify-center items-center px-2 sm:px-6 md:px-8">
        ...
        <div className="flex flex-col justify-center items-center gap-6 px-4 sm:px-6 md:px-8 py-8">
          ...
          />
          <img
            src="/assets/red_latex_thong.jpeg"
            alt="Red Latex Thong"
            className="
      ...
      <div
        className="
          relative group
          w-full max-w-[720px] mx-auto px-4 py-4
      ...
      >
        ...
        <p
          className="
            relative z-10
            text-[8px] sm:text-[12px] tracking-wide
        ...
        <img
          ...
          alt="SEAL Team 69 – ST69 Patch"
          className="
            absolute top-1/2 left-1/2 w-12 sm:w-16
