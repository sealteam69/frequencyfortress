...
export default function ProvisionPage() {
  ...
  useEffect(() => {
    const launchDate = new Date('2025-07-07T00:00:00')
    const now = new Date()
  ...
  return (
    <main className="w-full text-black min-h-screen bg-white font-mono">

      <div className="max-w-4xl mx-auto text-center space-y-4 p-6">
        ...
        <div className="max-w-5xl mx-auto m-6 font-bold text-center text-base md:text-lg text-cyan-400">
          <p>{daysSinceLaunch !== null && `${daysSinceLaunch} DAYS SINCE THE VAULT WAS OPENED`}</p>
        </div>
        ...
        <img src="/assets/eddie_santiago_sigil.jpeg" className="mx-auto m-6 w-32" />
